 ...
 *      itemOperations={"get"}
 * )
 * Me permettre une lecture seul de mes sessions api
...
class Session
{
     ...
     * Généré une URL automatique type session/id/feedback
     */
    private $feedback;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Reaction", mappedBy="session")
     */
    private $reactions;
